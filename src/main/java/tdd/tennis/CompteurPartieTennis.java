...
public class CompteurPartieTennis {
	...
	/**
	 * Cette Methode permet de cr�er une nouvelle partie de tennis. Une partie
	...
	/**
	 * gere les avantages quand le joueur 1 a gagn�
	 * 
	 * @param partie une partie de tennis
	...
	/**
	 * gere les avantages quand le joueur 2 a gagn�
	 * 
	 * @param partie une partie de tennis
	 * @return une partie de tennis
	 */
