...
class CompteurPartieTennisTest {
	...
	@Test
	@DisplayName("Quand un joueur arrive � gagner 6 jeux et que son adversaire 4 ou moins jeux gagn�s, alors le joueur gagne un set")
	...
	@Test
	@DisplayName("Quand les deux joueurs ont 6 jeux gagn�, alors on passe en jeux decisif")
	...
	@Test
	@DisplayName("Quand il y a jeu d�cisif les points sont compt� par point")
	...
	@Test
	@DisplayName("Si un joueur gagne un point pendant un jeu decisif il passe de 0 � 1, puis 2, ... jusqu'� 7")
	...
	@Test
	@DisplayName("Le premier joueur a 2 sets gagn�s gagne la partie.")
	...
	@Test
	@DisplayName("Quand un joueur a gagn�, il n'est plus possible de changer les scores")
	...
	@Test
	@DisplayName("L'utilisateur doit �tre avertie que la partie est finie")
